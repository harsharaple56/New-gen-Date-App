...
type Nav = NativeStackNavigationProp<RootStackParamList, 'LocationPermission'>;
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          <View style={styles.iconWrap}>
            <Ionicons name="location" size={44} color={colors.purple} />
          </View>
          <Text style={styles.title}>Find people nearby</Text>
          <Text style={styles.subtitle}>
            We use your location to surface curated matches in your area. Your exact
            location is never shared with anyone.
          </Text>
        </View>

        <View style={styles.actions}>
          <PrimaryButton label="Enable Location" variant="purple" onPress={() => navigation.navigate('NotificationPermission')} />
